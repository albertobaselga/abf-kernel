...
start:
    ...
    ; print `OK` to screen: All previous checks pass and long mode enabled
    ; Printing with x64 registers!
...
; CPUID detection: Instruction to get variuos info from CPU
check_cpuid:
...
; Check if we can use long mode (64bits) in the CPU
check_long_mode:
